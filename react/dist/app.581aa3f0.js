...
},{"./factoryWithTypeCheckers":"../node_modules/prop-types/factoryWithTypeCheckers.js"}],"../src/components/channels/Channels.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Channels, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          activeChannel = _this$props2.activeChannel;
      var active = channel === activeChannel ? "active font-weight-bold" : "";
...
Channels.propTypes = {
  ...
  setChannel: _propTypes.default.func.isRequired,
  activeChannel: _propTypes.default.object.isRequired
};
var _default = Channels;
exports.default = _default;
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/prop-types/index.js"}],"../src/components/channels/ChannelList.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  _createClass(ChannelList, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("ul", null, this.props.channels.map(function (chan) {
        return _react.default.createElement(_Channels.default, _extends({
          key: chan.id,
          channel: chan
        }, _this.props));
      }));
...
var _default = ChannelList;
exports.default = _default;
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/prop-types/index.js","./Channels":"../src/components/channels/Channels.js"}],"../src/components/channels/ChannelForm.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  function ChannelForm() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(ChannelForm)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onSubmit", function (e) {
      e.preventDefault();
      var node = _this.refs.channel;
      var channelName = node.value;

      _this.props.addChannel(channelName);
...
ChannelForm.propTypes = {
  addChannel: _propTypes.default.func.isRequired
};
var _default = ChannelForm;
exports.default = _default;
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/prop-types/index.js"}],"../src/components/channels/ChannelSection.js":[function(require,module,exports) {
"use strict";
...
var _ChannelForm = _interopRequireDefault(require("./ChannelForm"));
...
function (_Component) {
  ...
  _createClass(ChannelSection, [{
    ...
    value: function render() {
      ...
      }, "Chat Websocket"), _react.default.createElement("h3", {
        style: {
          fontFamily: "Sans-serif",
          fontWeight: "700",
          fontSize: "12pt",
      ...
      }, this.props.connected ? "Connected" : "Disconnect"), _react.default.createElement(_ChannelList.default, this.props), _react.default.createElement(_ChannelForm.default, this.props)));
    }
  }]);
...
},{"react":"../node_modules/react/index.js","prop-types":"../node_modules/prop-types/index.js","./ChannelList":"../src/components/channels/ChannelList.js","./ChannelForm":"../src/components/channels/ChannelForm.js"}],"../src/components/users/index.js":[function(require,module,exports) {
"use strict";
...
var _ChannelSection = _interopRequireDefault(require("../channels/ChannelSection"));
...
function (_Component) {
  ...
  function User() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getchannel", function () {
      _this.socket.onmessage = function (e) {
        var channels = _this.state.channels;
        channels.push({
          id: channels.length,
          name: JSON.parse(e.data)
        });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "addChannel", function (name) {
      // let { channels } = this.state;
      // channels.push({ id: channels.length, name });
      _this.socket.send(name); // this.setState({ channels });

    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "setChannel", function (activeChannel) {
      _this.setState({
        activeChannel: activeChannel
      });
    });

    _this.socket = new WebSocket("ws://localhost:8080/echo");
    return _this;
  }
  ...
  _createClass(User, [{
    ...
    key: "render",
    value: function render() {
      return _react.default.createElement(_ChannelSection.default, _extends({
...
},{"react":"../node_modules/react/index.js","../channels/ChannelSection":"../src/components/channels/ChannelSection.js"}],"../src/app.js":[function(require,module,exports) {
"use strict";
...
_reactDom.default.render(_react.default.createElement(_users.default, null), document.getElementById("root"));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./components/users":"../src/components/users/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
